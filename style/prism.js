! function(n) {
    ...
    (function(e) {
        var t, n, a, r, i, h, o, s, l, d, u, c, p, g, f, m, b, y, v, w, k = function(d) {
                ...
                N = {
                        ...
                        clone: function n(e, a) {
                            ...
                            switch (a = a || {}, N.util.type(e)) {
                                case "Object":
                                    ...
                                    for (var i in r = {}, a[t] = r, e) e.hasOwnProperty(i) && (r[i] = n(e[i], a));
                                    return r;
                                case "Array":
                                    return t = N.util.objId(e), a[t] ? a[t] : (r = [], a[t] = r, e.forEach(function(e, t) {
                                        r[t] = n(e, a)
                                    }), r);
                                default:
                                    return e
                    ...
                    languages: {
                        ...
                        insertBefore: function(n, e, t, a) {
                            ...
                            return a[n] = i, N.languages.DFS(N.languages, function(e, t) {
                                t === l && e != n && (this[e] = i)
                            }), i
                        },
                        DFS: function e(t, n, a, r) {
                            r = r || {};
                            var i, o, s = N.util.objId;
                            for (var l in t) {
                                t.hasOwnProperty(l) && (n.call(t, l, t[l], a || l), i = t[l], "Object" !== (o = N.util.type(i)) || r[s(i)] ? "Array" !== o || r[s(i)] || (r[s(i)] = !0, e(i, n, l, r)) : (r[s(i)] = !0, e(i, n, null, r)))
                            }
                        }
                    },
                    plugins: {},
                    ...
                    highlightAllUnder: function(e, t, n) {
                        ...
                        for (var r, i = 0; r = a.elements[i++];) N.highlightElement(r, !0 === t, a.callback)
                    },
                    highlightElement: function(e, t, n) {
                        ...
                        i && "pre" === i.nodeName.toLowerCase() && (i.className = i.className.replace(u, "").replace(/\s+/g, " ") + " language-" + a);
                        var o, s = {
                            element: e,
                            language: a,
                            grammar: r,
                                ...
                                for (var s in a)
                                    if (a.hasOwnProperty(s) && a[s])
                                        for (var l = a[s], l = Array.isArray(l) ? l : [l], d = 0; d < l.length; ++d) {
                                            ...
                                            for (var h = c.pattern || c, y = r.next, v = i; y !== n.tail && !(o && v >= o.reach); v += y.value.length, y = y.next) {
                                                var w = y.value;
            ...
            if (d.Prism = N, O.stringify = function t(e, n) {
                    ...
                    var r = {
                        ...
                        i = e.alias;
                    i && (Array.isArray(i) ? Array.prototype.push.apply(r.classes, i) : r.classes.push(i)), N.hooks.run("wrap", r);
                    var o = "";
                ...
                var t = JSON.parse(e.data),
                    ...
                    a = t.code,
                    r = t.immediateClose;
                d.postMessage(N.highlight(a, N.languages[n], n)), r && d.close()
            }, !1)), N;
        ...
        we.exports && (we.exports = k), void 0 !== e && (e.Prism = k), k.languages.markup = {
                comment: /<!--[\s\S]*?-->/,
                prolog: /<\?[\s\S]+?\?>/,
                doctype: {
                    pattern: /<!DOCTYPE(?:[^>"'[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^<"'\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i,
            ...
            }, k.languages.markup.tag.inside["attr-value"].inside.entity = k.languages.markup.entity, k.languages.markup.doctype.inside["internal-subset"].inside = k.languages.markup, k.hooks.add("wrap", function(e) {
            ...
            }), k.languages.html = k.languages.markup, k.languages.mathml = k.languages.markup, k.languages.svg = k.languages.markup, k.languages.xml = k.languages.extend("markup", {}), k.languages.ssml = k.languages.xml, k.languages.atom = k.languages.xml, k.languages.rss = k.languages.xml,
            function(e) {
                var t = /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1/;
                e.languages.css = {
                    comment: /\/\*[\s\S]*?\*\//,
                ...
                "class-name": [k.languages.clike["class-name"], {
                ...
                operator: /--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-+*/%&|^!=<>]=?|\.{3}|\?\?=?|\?\.?|[~:]/
            }), k.languages.javascript["class-name"][0].pattern = /(\b(?:class|interface|extends|implements|instanceof|new)\s+)[\w.\\]+/, k.languages.insertBefore("javascript", "keyword", {
                regex: {
            ...
            }), k.languages.markup && k.languages.markup.tag.addInlined("script", "javascript"), k.languages.js = k.languages.javascript, k.languages.actionscript = k.languages.extend("javascript", {
                keyword: /\b(?:as|break|case|catch|class|const|default|delete|do|else|extends|finally|for|function|if|implements|import|in|instanceof|interface|internal|is|native|new|null|package|private|protected|public|return|super|switch|this|throw|try|typeof|use|var|void|while|with|dynamic|each|final|get|include|namespace|native|override|set|static)\b/,
                operator: /\+\+|--|(?:[+\-*\/%^]|&&?|\|\|?|<<?|>>?>?|[!=]=?)=?|[~?@]/
            }), k.languages.actionscript["class-name"].alias = "function", k.languages.markup && k.languages.insertBefore("actionscript", "string", {
                xml: {
            ...
            function(e) {
                ...
                for (var r = ["comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"], i = a.variable[1].inside, o = 0; o < r.length; o++) i[r[o]] = e.languages.bash[r[o]];
                e.languages.shell = e.languages.bash
            }(k), k.languages.c = k.languages.extend("clike", {
                comment: {
                    pattern: /\/\/(?:[^\r\n\\]|\\(?:\r\n?|\n|(?![\r\n])))*|\/\*[\s\S]*?(?:\*\/|$)/,
                    greedy: !0
                },
            ...
            function(n) {
                ...
                n.languages.csharp = n.languages.extend("clike", {
                    ...
                    "class-name": [{
                        ...
                        pattern: r("(\\busing\\s+<<0>>\\s*=\\s*)<<1>>(?=\\s*;)", [m, w]),
                        lookbehind: !0,
                        inside: k
                    }, {
                        ...
                        pattern: r("\\b<<0>>(?=\\s+(?!<<1>>)<<2>>(?:\\s*[=,;:{)\\]]|\\s+(?:in|when)\\b))", [w, p, m]),
                        inside: k
                    }],
                    keyword: u,
                    ...
                    namespace: {
                        pattern: r("(\\b(?:namespace|using)\\s+)<<0>>(?:\\s*\\.\\s*<<0>>)*(?=\\s*[;{])", [m]),
                        lookbehind: !0,
                        inside: {
                            punctuation: /\./
                        }
                    ...
                    "type-expression": {
                        pattern: r("(\\b(?:default|typeof|sizeof)\\s*\\(\\s*)(?:[^()\\s]|\\s(?!\\s*\\))|<<0>>)*(?=\\s*\\))", [f]),
                        lookbehind: !0,
                        alias: "class-name",
                        inside: k
                    },
                    "return-type": {
                        pattern: r("<<0>>(?=\\s+(?:<<1>>\\s*(?:=>|[({]|\\.\\s*this\\s*\\[)|this\\s*\\[))", [w, h]),
                        inside: k,
                        alias: "class-name"
                    },
                    ...
                    "type-list": {
                        pattern: r("\\b((?:<<0>>\\s+<<1>>|where\\s+<<2>>)\\s*:\\s*)(?:<<3>>|<<4>>)(?:\\s*,\\s*(?:<<3>>|<<4>>))*(?=\\s*(?:where|[{;]|=>|$))", [d, b, m, w, u.source]),
                        lookbehind: !0,
                        inside: {
                            keyword: u,
                            "class-name": {
                ...
                n.languages.insertBefore("csharp", "class-name", {
                    attribute: {
                        pattern: r("((?:^|[^\\s\\w>)?])\\s*\\[\\s*)(?:<<0>>\\s*:\\s*)?<<1>>(?:\\s*,\\s*<<1>>)*(?=\\s*\\])", [T, C]),
                        lookbehind: !0,
                        greedy: !0,
                        inside: {
                            target: {
            ...
            }(k), k.languages.dotnet = k.languages.cs = k.languages.csharp, n = /\b(?:alignas|alignof|asm|auto|bool|break|case|catch|char|char8_t|char16_t|char32_t|class|compl|concept|const|consteval|constexpr|constinit|const_cast|continue|co_await|co_return|co_yield|decltype|default|delete|do|double|dynamic_cast|else|enum|explicit|export|extern|float|for|friend|goto|if|inline|int|int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|long|mutable|namespace|new|noexcept|nullptr|operator|private|protected|public|register|reinterpret_cast|requires|return|short|signed|sizeof|static|static_assert|static_cast|struct|switch|template|this|thread_local|throw|try|typedef|typeid|typename|union|unsigned|using|virtual|void|volatile|wchar_t|while)\b/, (t = k).languages.cpp = t.languages.extend("c", {
                "class-name": [{
            ...
            }), t.languages.insertBefore("inside", "operator", {
                "class-name": /\b[a-z_]\w*\b(?!\s*::)/i
            }, t.languages.cpp["base-clause"]), r = /#(?!\{).+/, i = {
                pattern: /#\{[^}]+\}/,
                alias: "variable"
                ...
                property: /(?!\d)\w+(?=\s*:(?!:))/
            }), delete a.languages.coffeescript["template-string"], a.languages.coffee = a.languages.coffeescript, k.languages.csp = {
                directive: {
                    ...
                    value: function(g, f) {
                        ...
                        g.language === f && g.tokenStack && (g.grammar = h.languages[f], m = 0, b = Object.keys(g.tokenStack), function e(t) {
                            for (var n = 0; n < t.length && !(m >= b.length); n++) {
                                var a, r, i, o, s, l, d, u, c, p = t[n];
                                "string" == typeof p || p.content && "string" == typeof p.content ? (a = b[m], r = g.tokenStack[a], i = "string" == typeof p ? p : p.content, o = S(f, a), -1 < (s = i.indexOf(o)) && (++m, l = i.substring(0, s), d = new h.Token(f, h.tokenize(r, g.grammar), "language-" + f, r), u = i.substring(s + o.length), c = [], l && c.push.apply(c, e([l])), c.push(d), u && c.push.apply(c, e([u])), "string" == typeof p ? t.splice.apply(t, [n, 1].concat(c)) : p.content = c)) : p.content && e(p.content)
                            }
                            return t
                        }(g.tokens))
                    }
            ...
            function(e) {
                ...
                punctuation: /---|\.\.\.|[:[\]{}\-,|>?]/
            }, k.languages.dockerfile = k.languages.docker, k.languages.elixir = {
                comment: /#.*/m,
                regex: {
            ...
            }), (o = k).languages.flow = o.languages.extend("javascript", {}), o.languages.insertBefore("flow", "keyword", {
                type: [{
                    pattern: /\b(?:[Nn]umber|[Ss]tring|[Bb]oolean|Function|any|mixed|null|void)\b/,
                    alias: "tag"
                }]
            }), o.languages.flow["function-variable"].pattern = /[_$a-z\xA0-\uFFFF][$\w\xA0-\uFFFF]*(?=\s*=\s*(?:function\b|(?:\([^()]*\)(?:\s*:\s*\w+)?|[_$a-z\xA0-\uFFFF][$\w\xA0-\uFFFF]*)\s*=>))/i, delete o.languages.flow.parameter, o.languages.insertBefore("flow", "operator", {
                "flow-punctuation": {
                    pattern: /\{\||\|\}/,
                    alias: "punctuation"
                }
            }), Array.isArray(o.languages.flow.keyword) || (o.languages.flow.keyword = [o.languages.flow.keyword]), o.languages.flow.keyword.unshift({
            ...
            }), delete k.languages.go["class-name"], k.languages.graphql = {
                comment: /#.*/,
                description: {
                    pattern: /(?:"""(?:[^"]|(?!""")")*"""|"(?:\\.|[^\\"\r\n])*")(?=\s*[a-z_])/i,
                    greedy: !0,
            ...
            function(e) {
                ...
                s.languages["markup-templating"].buildPlaceholders(e, "handlebars", /\{\{\{[\s\S]+?\}\}\}|\{\{[\s\S]+?\}\}/g)
            }), s.hooks.add("after-tokenize", function(e) {
                s.languages["markup-templating"].tokenizePlaceholders(e, "handlebars")
            }), k.languages.haskell = {
                comment: {
                    pattern: /(^|[^-!#$%*+=?&@|~.:<>^\\\/])(?:--(?:(?=.)[^-!#$%*+=?&@|~.:<>^\\\/].*|$)|{-[\s\S]*?-})/m,
                    lookbehind: !0
            ...
            function(e) {
                ...
                for (var l in o) {
                    o[l] && (t = t || {}, r = s[l] ? (a = (n = l).replace(/^[a-z]+\//, ""), "(?:" + n + "|\\w+/(?:[\\w.-]+\\+)+" + a + "(?![+\\w.-]))") : l, t[l.replace(/\//g, "-")] = {
                        pattern: RegExp("(content-type:\\s*" + r + "[\\s\\S]*?)(?:\\r?\\n|\\r){2}[\\s\\S]*", "i"),
                        lookbehind: !0,
                        inside: o[l]
                    })
                }
                t && e.languages.insertBefore("http", "header-name", t)
            }(k), d = /\b(?:abstract|assert|boolean|break|byte|case|catch|char|class|const|continue|default|do|double|else|enum|exports|extends|final|finally|float|for|goto|if|implements|import|instanceof|int|interface|long|module|native|new|non-sealed|null|open|opens|package|permits|private|protected|provides|public|record|requires|return|sealed|short|static|strictfp|super|switch|synchronized|this|throw|throws|to|transient|transitive|try|uses|var|void|volatile|while|with|yield)\b/, u = /\b[A-Z](?:\w*[a-z]\w*)?\b/, (l = k).languages.java = l.languages.extend("clike", {
                "class-name": [u, /\b[A-Z]\w*(?=\s+\w+\s*[;,=())])/],
                keyword: d,
                function: [l.languages.clike.function, {
                    pattern: /(\:\:)[a-z_]\w*/,
                    lookbehind: !0
                }],
            ...
            function(e) {
                ...
                punctuation: /[[\]{}&]/
            }, c.languages.tex = c.languages.latex, c.languages.context = c.languages.latex, k.languages.less = k.languages.extend("css", {
                comment: [/\/\*[\s\S]*?\*\//, {
                    pattern: /(^|[^\\])\/\/.*/,
                    lookbehind: !0
                }],
                ...
                return m
            }), y = "\\|?[ \t]*:?-{3,}:?[ \t]*(?:\\|[ \t]*:?-{3,}:?[ \t]*)+\\|?(?:\n|\r\n?)", f.languages.markdown = f.languages.extend("markup", {}), f.languages.insertBefore("markdown", "prolog", {
                blockquote: {
                    pattern: /^>(?:[\t ]*>)*/m,
                    alias: "punctuation"
                },
                ...
                ["url", "bold", "italic", "strike"].forEach(function(e) {
                    t !== e && (f.languages.markdown[t].inside.content.inside[e] = f.languages.markdown[e])
                })
                ...
                "markdown" !== e.language && "md" !== e.language || ! function e(t) {
                    if (t && "string" != typeof t)
                        for (var n = 0, a = t.length; n < a; n++) {
                            var r, i, o, s, l = t[n];
                            "code" === l.type ? (r = l.content[1], i = l.content[3], r && i && "code-language" === r.type && "code-block" === i.type && "string" == typeof r.content && (o = r.content.replace(/\b#/g, "sharp").replace(/\b\+\+/g, "pp"), s = "language-" + (o = (/[a-z][\w-]*/i.exec(o) || [""])[0].toLowerCase()), i.alias ? "string" == typeof i.alias ? i.alias = [i.alias, s] : i.alias.push(s) : i.alias = [s])) : e(l.content)
                        }
                }(e.tokens)
                ...
                if ("code-block" === e.type) {
                    ...
                    var o, s, l = f.languages[t];
                    l ? (o = e.content.replace(/&lt;/g, "<").replace(/&amp;/g, "&"), e.content = f.highlight(o, l, t)) : t && "none" !== t && f.plugins.autoloader && (s = "md-" + (new Date).valueOf() + "-" + Math.floor(1e16 * Math.random()), e.attributes.id = s, f.plugins.autoloader.loadLanguages(t, function() {
                        var e = document.getElementById(s);
                        e && (e.innerHTML = f.highlight(e.textContent, f.languages[t], t))
                    }))
                }
            }), f.languages.md = f.languages.markdown, k.languages.objectivec = k.languages.extend("c", {
                keyword: /\b(?:asm|typeof|inline|auto|break|case|char|const|continue|default|do|double|else|enum|extern|float|for|goto|if|int|long|register|return|short|signed|sizeof|static|struct|switch|typedef|union|unsigned|void|volatile|while|in|self|super)\b|(?:@interface|@end|@implementation|@protocol|@class|@public|@protected|@private|@property|@try|@catch|@finally|@throw|@synthesize|@dynamic|@selector)\b/,
                string: /("|')(?:\\(?:\r\n|[\s\S])|(?!\1)[^\\\r\n])*\1|@"(?:\\(?:\r\n|[\s\S])|[^"\\\r\n])*"/,
                operator: /-[->]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|\|?|[~^%?*\/@]/
            }), delete k.languages.objectivec["class-name"], k.languages.objc = k.languages.objectivec, k.languages.ocaml = {
                comment: /\(\*[\s\S]*?\*\)/,
                string: [{
                    pattern: /"(?:\\.|[^\\\r\n"])*"/,
                    greedy: !0
            ...
            function(t) {
            ...
            }(k), k.languages.insertBefore("php", "variable", {
                this: /\$this\b/,
                ...
                punctuation: /[|{}[\];(),.]/
            }, (w = v.string[0].inside).boolean = v.boolean, w.variable = v.variable, w.function.inside = v, k.languages.processing = k.languages.extend("clike", {
            ...
            }), k.languages.processing.function = /\w+(?=\s*\()/, k.languages.processing["class-name"].alias = "variable",
            function(e) {
                e.languages.pug = {
                    comment: {
                        pattern: /(^([\t ]*))\/\/.*(?:(?:\r?\n|\r)\2[\t ]+.+)*/m,
                ...
                operator: /[-+%=]=?|!=|\*\*?=?|\/\/?=?|<[<=>]?|>[=>]?|[&|^~]/,
                punctuation: /[{}[\];(),.:]/
            }, k.languages.python["string-interpolation"].inside.interpolation.inside.rest = k.languages.python, k.languages.py = k.languages.python, k.languages.r = {
                comment: /#.*/,
                string: {
                    pattern: /(['"])(?:\\.|(?!\1)[^\\\r\n])*\1/,
                    greedy: !0
                ...
                s.hooks.add("after-tokenize", function(e) {
                    "jsx" !== e.language && "tsx" !== e.language || function e(t) {
                        for (var n = [], a = 0; a < t.length; a++) {
                            var r, i = t[a],
                                o = !1;
                            "string" != typeof i && ("tag" === i.type && i.content[0] && "tag" === i.content[0].type ? "</" === i.content[0].content[0].content ? 0 < n.length && n[n.length - 1].tagName === l(i.content[0].content[1]) && n.pop() : "/>" === i.content[i.content.length - 1].content || n.push({
                                tagName: l(i.content[0].content[1]),
                                openedBraces: 0
                            }) : 0 < n.length && "punctuation" === i.type && "{" === i.content ? n[n.length - 1].openedBraces++ : 0 < n.length && 0 < n[n.length - 1].openedBraces && "punctuation" === i.type && "}" === i.content ? n[n.length - 1].openedBraces-- : o = !0), (o || "string" == typeof i) && 0 < n.length && 0 === n[n.length - 1].openedBraces && (r = l(i), a < t.length - 1 && ("string" == typeof t[a + 1] || "plain-text" === t[a + 1].type) && (r += l(t[a + 1]), t.splice(a + 1, 1)), 0 < a && ("string" == typeof t[a - 1] || "plain-text" === t[a - 1].type) && (r = l(t[a - 1]) + r, t.splice(a - 1, 1), a--), t[a] = new s.Token("plain-text", r, null, r)), i.content && "string" != typeof i.content && e(i.content)
                        }
                    }(e.tokens)
                })
            }(k),
        ...
        var x, A, _, T, C, R, L, I, N, O, F, D, P, B, M, $, z, q, U, j, G, H, Z, W, K, V, Y, X, Q, J, ee, te, ne, ae, re, ie, oe, se = k.util.clone(k.languages.typescript);
        ...
        function ge(d, e, u) {
            ...
            t.forEach(function(e) {
                ...
                }), g && k.plugins.lineNumbers ? (t = k.plugins.lineNumbers.getLine(d, o), n = k.plugins.lineNumbers.getLine(d, s), t && (a = t.offsetTop + "px", m.push(function() {
                    l.style.top = a
                })), n && (r = n.offsetTop - t.offsetTop + n.offsetHeight + "px", m.push(function() {
                    l.style.height = r
                }))) : m.push(function() {
            ...
            if (g && a) {
                ...
                i && (ce(d, n) || m.push(function() {
                    d.className = (d.className + " " + n).trim()
                }), r = parseInt(d.getAttribute("data-start") || "1"), ue(".line-numbers-rows > span", d).forEach(function(e, t) {
                    var n = t + r;
                    e.onclick = function() {
                        var e = a + "." + n;
                        P = !1, location.hash = e, setTimeout(function() {
                            P = !0
                        }, 1)
                    }
                }))
        ...
        function fe() {
            ...
            a && !document.getElementById(e) && (t = e.slice(0, e.lastIndexOf(".")), (n = document.getElementById(t)) && (n.hasAttribute("data-line") || n.setAttribute("data-line", ""), ge(n, a, "temporary ")(), P && document.querySelector(".temporary.line-highlight").scrollIntoView()))
        }
        ...
        function me(e) {
            ...
            0 != (e = e.filter(function(e) {
                ...
                var a = e.sizer,
                    ...
                    r = e.lineHeights,
                    i = e.oneLinerHeight;
                r[t.length - 1] = void 0, t.forEach(function(e, t) {
                    var n;
                    e && 1 < e.length ? ((n = a.appendChild(document.createElement("span"))).style.display = "block", n.textContent = e) : r[t] = i
                })
            }), t.forEach(function(e) {
        ...
        function be(e, t) {
            t = t || e.name, "function" != typeof e || he(e) || he(t) || j.push({
                adapter: e,
                name: t
            })
        }
        ...
        k.languages.tsx = k.languages.extend("jsx", se), k.languages.reason = k.languages.extend("clike", {
                string: {
                    pattern: /"(?:\\(?:\r\n|[\s\S])|[^\\\r\n"])*"/,
                    greedy: !0
                },
            ...
            }(k), k.languages.scss = k.languages.extend("css", {
                comment: {
                    pattern: /(^|[^\\])(?:\/\*[\s\S]*?\*\/|\/\/.*)/,
                    lookbehind: !0
                },
            ...
            }), k.languages.scss.atrule.inside.rest = k.languages.scss, k.languages.scheme = {
                comment: /;.*|#;\s*\((?:[^()]|\([^()]*\))*\)|#\|(?:[^#|]|#(?!\|)|\|(?!#)|#\|(?:[^#|]|#(?!\|)|\|(?!#))*\|#)*\|#/,
                string: {
                    pattern: /"(?:[^"\\]|\\.)*"/,
                    greedy: !0
            ...
            }), k.languages.swift.string.inside.interpolation.inside.rest = k.languages.swift,
            function() {
                function e(e, t) {
                ...
                i.bold.inside = r, i.italic.inside = r, i.inserted.inside = r, i.deleted.inside = r, i.span.inside = r;
                var o = a.table.inside;
                o.inline = r.inline, o.link = r.link, o.image = r.image, o.footnote = r.footnote, o.acronym = r.acronym, o.mark = r.mark
            }(), k.languages.toml = {
                comment: {
                    pattern: /#.*/,
                    greedy: !0
                ...
                table: {
                    pattern: RegExp(le("(^\\s*\\[\\s*(?:\\[\\s*)?)__(?:\\s*\\.\\s*__)*(?=\\s*\\])"), "m"),
                    lookbehind: !0,
                    greedy: !0,
                    alias: "class-name"
                },
                key: {
                    pattern: RegExp(le("(^\\s*|[{,]\\s*)__(?:\\s*\\.\\s*__)*(?=\\s*=)"), "m"),
                    lookbehind: !0,
                    greedy: !0,
                    alias: "property"
                },
                ...
                punctuation: /[{}().,:?]/
            }, k.languages.vb = k.languages["visual-basic"], k.languages.vba = k.languages["visual-basic"], k.languages.wasm = {
                comment: [/\(;[\s\S]*?;\)/, {
                    pattern: /;;.*/,
                    greedy: !0
                }],
                ...
                punctuation: /[()]/
            }, C = k, I = "(?:" + (L = /!(?:<[\w\-%#;/?:@&=+$,.!~*'()[\]]+>|(?:[a-zA-Z\d-]*!)?[\w\-%#;/?:@&=+$.~*'()]+)?/).source + "(?:[ \t]+" + (R = /[*&][^\s[\]{},]+/).source + ")?|" + R.source + "(?:[ \t]+" + L.source + ")?)", N = "(?:[^\\s\\x00-\\x08\\x0e-\\x1f!\"#%&'*,\\-:>?@[\\]`{|}\\x7f-\\x84\\x86-\\x9f\\ud800-\\udfff\\ufffe\\uffff]|[?:-]<PLAIN>)(?:[ \t]*(?:(?![#:])<PLAIN>|:<PLAIN>))*".replace(/<PLAIN>/g, function() {
                ...
                datetime: {
                    pattern: de("\\d{4}-\\d\\d?-\\d\\d?(?:[tT]|[ \t]+)\\d\\d?:\\d{2}:\\d{2}(?:\\.\\d*)?[ \t]*(?:Z|[-+]\\d\\d?(?::\\d{2})?)?|\\d{4}-\\d{2}-\\d{2}|\\d\\d?:\\d{2}(?::\\d{2}(?:\\.\\d*)?)?"),
                    lookbehind: !0,
                    alias: "number"
                },
                boolean: {
                ...
                number: {
                    pattern: de("[+-]?(?:0x[\\da-f]+|0o[0-7]+|(?:\\d+\\.?\\d*|\\.?\\d+)(?:e[+-]?\\d+)?|\\.inf|\\.nan)", "i"),
                    lookbehind: !0
                },
                tag: L,
                important: R,
                punctuation: /---|[:[\]{}\-,|>?]|\.\.\./
            }, C.languages.yml = C.languages.yaml, "undefined" != typeof self && self.Prism && self.document && document.querySelector && (D = function() {
                var e;
                return void 0 === F && ((e = document.createElement("div")).style.fontSize = "13px", e.style.lineHeight = "1.5", e.style.padding = "0", e.style.border = "0", e.innerHTML = "&nbsp;<br />&nbsp;", document.body.appendChild(e), F = 38 === e.offsetHeight, document.body.removeChild(e)), F
            }, P = !0, B = 0, k.hooks.add("before-sanity-check", function(e) {
                var t, n = e.element.parentNode,
                    a = n && n.getAttribute("data-line");
                n && a && /pre/i.test(n.nodeName) && (t = 0, ue(".line-highlight", n).forEach(function(e) {
                ...
                var n, a, r = t.element.parentNode,
                    i = r && r.getAttribute("data-line");
                r && i && /pre/i.test(r.nodeName) && (clearTimeout(B), n = k.plugins.lineNumbers, a = t.plugins && t.plugins.lineNumbers, ce(r, "line-numbers") && n && !a ? k.hooks.add("line-numbers", e) : (ge(r, i)(), B = setTimeout(fe, 1)))
            }), window.addEventListener("hashchange", fe), window.addEventListener("resize", function() {
                ue("pre[data-line]").map(function(e) {
                    return ge(e)
                }).forEach(pe)
            })), "undefined" != typeof self && self.Prism && self.document && (M = "line-numbers", $ = /\n(?!$)/g, z = k.plugins.lineNumbers = {
            ...
            }, U = void 0, window.addEventListener("resize", function() {
                z.assumeViewportIndependence && U === window.innerWidth || (U = window.innerWidth, me(Array.prototype.slice.call(document.querySelectorAll("pre." + M))))
            }), k.hooks.add("complete", function(e) {
                var t, n, a, r, i, o;
                !e.code || (n = (t = e.element).parentNode) && /pre/i.test(n.nodeName) && !t.querySelector(".line-numbers-rows") && k.util.isActive(t, M) && (t.classList.remove(M), n.classList.add(M), i = (r = e.code.match($)) ? r.length + 1 : 1, o = new Array(i + 1).join("<span></span>"), (a = document.createElement("span")).setAttribute("aria-hidden", "true"), a.className = "line-numbers-rows", a.innerHTML = o, n.hasAttribute("data-start") && (n.style.counterReset = "linenumber " + (parseInt(n.getAttribute("data-start"), 10) - 1)), e.element.appendChild(a), me([n]), k.hooks.run("line-numbers", e))
            }), k.hooks.add("line-numbers", function(e) {
                e.plugins = e.plugins || {}, e.plugins.lineNumbers = !0
            })), "undefined" != typeof self && self.Prism && self.document && (j = [], be(function(e, t) {
                if (e && e.meta && e.data) {
                ...
                return null
            }, "gist"), be(function(e, t) {
                return e && e.node && "string" == typeof e.data ? e.data : null
            }, "bitbucket"), G = 0, W = "failed", K = "pre[data-jsonp]:not([" + (H = "data-jsonp-status") + '="loaded"]):not([' + H + '="' + (Z = "loading") + '"])', k.hooks.add("before-highlightall", function(e) {
                e.selector += ", " + K
                ...
                if (r.matches(K)) {
                    ...
                    var a = r.getAttribute("data-adapter"),
                        o = null;
                    if (a) {
                        if ("function" != typeof window[a]) return r.setAttribute(H, W), void(i.textContent = '✖ Error: JSONP adapter function "' + a + "\" doesn't exist");
                        o = window[a]
                    }
                    var s = "prismjsonp" + G++,
                        l = document.createElement("a"),
                        d = l.href = r.getAttribute("data-jsonp");
                    l.href += (l.search ? "&" : "?") + (r.getAttribute("data-callback") || "callback") + "=" + s;
                    var u = setTimeout(function() {
                            r.setAttribute(H, W), i.textContent = "✖ Error: Timeout loading " + d
                    ...
                    c.src = l.href, window[s] = function(e) {
                        ...
                        if (o) t = o(e, r);
                            ...
                            for (var n = 0, a = j.length; n < a && null === (t = j[n].adapter(e, r)); n++);
                        null === t ? (r.setAttribute(H, W), i.textContent = "✖ Error: Cannot parse response (perhaps you need an adapter function?)") : (r.setAttribute(H, "loaded"), i.textContent = t, k.highlightElement(i))
                ...
                removeAdapter: function(t) {
                    var e;
                    "string" == typeof t && (t = he(t)), "function" == typeof t && 0 <= (e = j.findIndex(function(e) {
                        return e.adapter === t
                    })) && j.splice(e, 1)
                },
                highlight: function(e) {
                    for (var t, n = (e || document).querySelectorAll(K), a = 0; t = n[a++];) k.highlightElement(t)
                }
            }), "undefined" != typeof self && self.Prism && self.document && (V = /(?:^|\s)command-line(?:\s|$)/, Y = "command-line-prompt", X = "".startsWith ? function(e, t) {
                ...
                if (!t.complete && e.code) {
                    ...
                    if (n && /pre/i.test(n.nodeName) && (V.test(n.className) || V.test(e.element.className))) {
                        ...
                        if (null !== r) r.split(",").forEach(function(e) {
                            ...
                            for (var l = 0; l < i.length; l++) X(i[l], s) && (o[l] = i[l].slice(s.length), i[l] = "");
                        e.code = i.join("\n")
                    } else t.complete = !0
                } else t.complete = !0
                ...
                var t = ve(e);
                if (!t.complete) {
                    for (var n = e.highlightedCode.split("\n"), a = t.outputLines || [], r = 0, i = a.length; r < i; r++) a.hasOwnProperty(r) && (n[r] = a[r]);
                ...
                if (!t.complete) {
                    var n = e.element.parentElement;
                    V.test(e.element.className) && (e.element.className = e.element.className.replace(V, " ")), V.test(n.className) || (n.className += " command-line");
                    var a = t.numberOfLines || 0,
                        r = c("data-prompt", ""),
                        i = ye("" !== r ? '<span data-prompt="' + r + '"></span>' : '<span data-user="' + c("data-user", "user") + '" data-host="' + c("data-host", "localhost") + '"></span>', a),
            ...
            })), "undefined" != typeof self && self.Prism && self.document && (Q = [], J = {}, ee = function() {}, k.plugins.toolbar = {}, te = k.plugins.toolbar.registerButton = function(e, n) {
                ...
                e in J ? console.warn('There is a button with the key "' + e + '" registered already.') : Q.push(J[e] = t)
            }, ne = k.plugins.toolbar.hook = function(a) {
                var e, r, t, n, i = a.element.parentNode;
                i && /pre/i.test(i.nodeName) && !i.parentNode.classList.contains("code-toolbar") && ((e = document.createElement("div")).classList.add("code-toolbar"), i.parentNode.insertBefore(e, i), e.appendChild(i), (r = document.createElement("div")).classList.add("toolbar"), t = Q, (n = function(e) {
                    for (; e;) {
                    ...
                    var t, n = e(a);
                    n && ((t = document.createElement("div")).classList.add("toolbar-item"), t.appendChild(n), r.appendChild(t))
                }), e.appendChild(r))
            }, te("label", function(e) {
            ...
            }), k.hooks.add("complete", ne)), "undefined" != typeof self && self.Prism && self.document && (k.plugins.toolbar ? (ae = (ae = window.ClipboardJS || void 0) || ke(4), re = [], ae || (ie = document.createElement("script"), oe = document.querySelector("head"), ie.onload = function() {
                if (ae = window.ClipboardJS)
                    for (; re.length;) re.pop()()
            }, ie.src = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js", oe.appendChild(ie)), k.plugins.toolbar.registerButton("copy-to-clipboard", function(e) {
    ...
    var a;
    a = function() {
        return a = {}, r.m = n = [function(e, t) {
            e.exports = function(e) {
                var t, n, a, r = "SELECT" === e.nodeName ? (e.focus(), e.value) : "INPUT" === e.nodeName || "TEXTAREA" === e.nodeName ? ((t = e.hasAttribute("readonly")) || e.setAttribute("readonly", ""), e.select(), e.setSelectionRange(0, e.value.length), t || e.removeAttribute("readonly"), e.value) : (e.hasAttribute("contenteditable") && e.focus(), n = window.getSelection(), (a = document.createRange()).selectNodeContents(e), n.removeAllRanges(), n.addRange(a), n.toString());
                return r
            }
        }, function(e, t) {
            function n() {}
            n.prototype = {
                ...
                off: function(e, t) {
                    var n = this.e || (this.e = {}),
                        ...
                        r = [];
                    if (a && t)
                        for (var i = 0, o = a.length; i < o; i++) a[i].fn !== t && a[i].fn._ !== t && r.push(a[i]);
            ...
            e.exports = function(e, t, n) {
                ...
                if (p.string(e)) return a = e, r = t, i = n, g(document.body, a, r, i);
